...
```
    cd "AWSLambdaS3.CloudFlarePurgeCache"
    dotnet restore
```

Execute unit tests
```
    cd "AWSLambdaS3.CloudFlarePurgeCache/test/AWSLambdaS3.CloudFlarePurgeCache.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "AWSLambdaS3.CloudFlarePurgeCache/src/AWSLambdaS3.CloudFlarePurgeCache"
